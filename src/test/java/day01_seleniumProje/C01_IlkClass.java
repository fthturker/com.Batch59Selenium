...
public class C01_IlkClass {
    public static void main(String[] args) throws InterruptedException {
        ...
        class'imiza otomasyon yapmak icin gerekli olan webdriver'in yerini gostermemiz gerekir
        bunun icin Java kutuphanesi'nden System.setProperty() methodu kullaniriz
